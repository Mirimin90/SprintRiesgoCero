...
Link repositorio Luis Reyes Miranda. https://github.com/LuisGReyesM/SptrintModulo5.git
Link repositorio Miriam Pulgar Estay. https://github.com/Mirimin90/SprintRiesgoCero
Link repositorio Juan Carlos Gallardo Caballero. https://github.com/JCSystemDev/RiesgoCero.git

Comentarios generales.

1.Se trabaja con la BD de datos creada y entregada para el ejercicio.
2.Si bien se usa la BD prevención , no se utilizan todas las tablas y los campos ya que el 
  ejercicio no los necesita.
2.Todas las páginas mantienen el mismo estilo. 
